  ...
  <div class="limiter">
    <div class="container-login100">
      <div class="wrap-login100">
        <form method="post" action="<?= base_url('auth/cek_username') ?>" class="login100-form validate-form">
          ...
          <div class="wrap-input100">
            <input class="input100" type="text" id="username" name="username" placeholder="Input Username Anda" required />
          ...
          <div class="text-center p-t-136">
            ...
            <a class="txt2 change_link" href="<?= base_url('auth'); ?>">
        ...
        <div class="login100-pic">
          <img src="<?= base_url('assets3') ?>/images/2.png" alt="IMG">
        </div>
      </div>
    </div>
  </div>
